...
<body id="page-top">
                    ...
                    <ul class="navbar-nav ml-auto">
                            ...
                            <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="messagesDropdown">
                                ...
                                <a class="dropdown-item d-flex align-items-center" href="#">
                                    <div class="dropdown-list-image mr-3">
                                        <img class="rounded-circle" src="<?= theme('assets/img/undraw_profile_1.svg', CONF_VIEW_ADMIN) ?>" alt="...">
                                ...
                                <a class="dropdown-item d-flex align-items-center" href="#">
                                    <div class="dropdown-list-image mr-3">
                                        <img class="rounded-circle" src="<?= theme('assets/img/undraw_profile_2.svg', CONF_VIEW_ADMIN) ?>" alt="...">
                                ...
                                <a class="dropdown-item d-flex align-items-center" href="#">
                                    <div class="dropdown-list-image mr-3">
                                        <img class="rounded-circle" src="<?= theme('assets/img/undraw_profile_3.svg', CONF_VIEW_ADMIN) ?>" alt="...">
                        ...
                        <!-- <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                ...
                                <img class="img-profile rounded-circle" src="<?= theme('assets/img/undraw_profile.svg', CONF_VIEW_ADMIN) ?>">
                            </a> -->
    ...
    <script src="<?= theme('assets/js/demo/chart-area-demo.js', CONF_VIEW_ADMIN) ?>"></script>
