                            ...
                            <?php if (Auth::auth()) : ?>
                                <li class="dropdown nav-item mx-1 align-self-lg-center">
                                    <a class="sidebar-brand  dropdown-toggle d-flex align-items-center justify-content-center" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                        <img class="img-profile  icon-circle " src="<?= Auth::auth() ? Auth::auth()->photo : theme('assets/img/undraw_profile.svg', CONF_VIEW_ADMIN) ?>">
                                    </a>
                ...
                <div class="row">
                    <div class="col-lg-3 col-md-6 col-12">
                        ...
                        <div class="single-footer ">
                            <div class="logo mb-3 text-center">
                                <a href="<?= url('home') ?>"><img style="height: 100px;" src="/storage/image/logo.png" alt="#"></a>
                            </div>
                        </div>
                        <!-- End Single Widget -->
                    </div>
                    <div class="col-lg-3 col-md-6 col-12">
                        ...
                        <div class="single-footer links">
                            <h4 class='text-white h5'>Informação</h4>
                            <ul class='ps-0'>
